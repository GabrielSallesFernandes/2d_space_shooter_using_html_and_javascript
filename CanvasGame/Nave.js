function Nave(context,teclado,image,imgExplosao){
...
Nave.prototype = {
	...
	colidiuCom: function(outro){
		//se colidiu com um ovni ele some
		if(outro instanceof Ovni){
			...
			var exp2 = new Explosao(this.context, this.imgExplosao,this.x, this.y);

			this.animacao.newSprite(exp1);
			this.animacao.newSprite(exp2);
			var nave = this;
			exp1.fimDaExplosao = function(){
				...
				if(nave.vidasExtras < 0){
					...
					nave.colisor.newSprite(nave);
					nave.animacao.newSprite(nave);
